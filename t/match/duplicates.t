...
ok(
    ! Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>snowflake</guid><link>butterfly</link>' ) ),
    'item with guid and link not seen before is not marked as a duplicate'
);

ok(
    ! Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>snowflakes</guid><link>moth</link>' ) ),
    'item with new guid sharing a prefix with previously seen guid is not marked as a duplicate'
);

ok(
    ! Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>raindrop</guid><link>butterfly net</link>' ) ),
...
ok(
    Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>coin</guid><link>butterfly</link>' ) ),
    'item with new guid and link seen before is marked as a duplicate'
);

ok(
    Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>snowflake</guid><link>ant</link>' ) ),
    'item with guid seen before and new link is marked as a duplicate'
);

ok(
    ! Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>memoirs</guid><link>confessions</link>' ) ),
    'item with new guid and new link not seen before is not marked as a duplicate'
);

ok(
    Rss::Match::Duplicates::match( Mojo::DOM->new( '<?xml version="1.0" encoding="UTF-8"?><guid>justified</guid><link>butterfly?species=sinner</link>' ) ),
